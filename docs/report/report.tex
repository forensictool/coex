...
Курсовая работа содержит \ESKDtotal{page} страницы, \ESKDtotal{figure} рисунков, \ESKDtotal{table} таблицы, \ESKDtotal{bibitem} источников, \ESKDtotal{appendix} приложение.
...
\input{individual_reports/next_semestr}
