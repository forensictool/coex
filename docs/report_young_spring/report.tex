...
\newpage
\subsection{Сбор информации из браузера Google Chrome} % - Отчёт Влада (новый)
\input{individual_reports/shipovskoy}

\newpage
\subsection{Cбор информации из мессенджера ICQ} % - Отчёт Марины
\input{individual_reports/MeytaMarina}

\newpage
\subsection{Cбор информации из почтового клиента MS Outlook} % - Отчёт Андрея
\input{individual_reports/SeryakovAndrey}
...
\input{individual_reports/LobanovOleg}
