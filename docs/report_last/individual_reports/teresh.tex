Главной задачей в данном семестре стало написание программного модуля для сбора сохраненных логинов и паролей браузера Mozilla Firefox.
...
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{teresh_3}}
...
\clearpage
\begin{figure}[h!]
\center{\includegraphics[width=0.7\linewidth]{teresh_4}}
