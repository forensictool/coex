...
\begin{figure}[h!]
\center{\includegraphics[width=0.9\linewidth]{ship_3}}
...
\begin{figure}[h!]
\center{\includegraphics[width=0.9\linewidth]{ship_4}}
\caption{ О программе }
\label{ship_4:ship_4}
\end{figure}

\begin{figure}[h!]
\center{\includegraphics[width=0.9\linewidth]{ship_5}}
...
\begin{figure}[h!]
\center{\includegraphics[width=0.9\linewidth]{ship_6}}
\caption{ Сообщение об ошибке }
\label{ship_6:ship_6}
\end{figure}

\begin{figure}[h!]
\center{\includegraphics[width=0.9\linewidth]{ship_7}}
